...
// PICO_CONFIG: PARAM_ASSERTIONS_ENABLED_PICO_TIMER, Enable/disable assertions in the timer module, type=bool, default=0, group=hardware_timer
...
static inline void check_hardware_alarm_num_param(__unused uint alarm_num) {
    invalid_params_if(PICO_TIMER, alarm_num >= NUM_TIMERS);
}
